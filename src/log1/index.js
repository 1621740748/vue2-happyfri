...
export default {
    install (Vue, {
        ...
        Vue.directive('report', {
            bind: (el, binding) => handleDirective(el, binding, 'bind', reportFunc, debug),
            unbind: (el, binding) => handleDirective(el, binding, 'unbind', reportFunc, debug)
        })
    }
}
